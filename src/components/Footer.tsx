      ...
      <div className={styles.inner}>
        <div className={styles.grid}>
          ...
          <div className={styles.brand}>
            ...
            <p className={styles.tagline}>
              The world&apos;s first AI-native tyre design and optimisation
              platform.
            </p>
          ...
          <div className={styles.navCol}>
            ...
            <Link href="/platform#compound-gen" className={styles.footerLink}>
              Compound Generation
            </Link>
            <Link href="/platform#simulation" className={styles.footerLink}>
              Performance Simulation
            </Link>
            <Link href="/platform#wear-modelling" className={styles.footerLink}>
              Wear &amp; Thermal Modelling
            </Link>
            <Link href="/platform#credits" className={styles.footerLink}>
              Credit Economy
            </Link>
          </div>
          ...
          <div className={styles.navCol}>
            ...
            <a
              href="mailto:contact@tyrebrainai.com"
        ...
        <div className={styles.bottom}>
          ...
          <p className={styles.bottomNote}>
            ...
            &nbsp;·&nbsp; Built by industry insiders. Powered by{" "}
            <a
