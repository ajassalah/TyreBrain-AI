...
const TyreVisual = dynamic(() => import("@/components/TyreVisual"), {
  ssr: false,
});
...
const STATS = [
  {
    ...
    sub: "Tyre sector expertise",
  },
  {
    value: "18",
    suffix: "mo",
    label: "Traditional R&D Cycle",
    sub: "Compressed by AI",
  },
  {
    value: "1B",
    suffix: "+",
    label: "Compound Permutations",
    sub: "Explored per optimisation run",
  },
];
...
const INTRO_SEEN_KEY = "tyrebrain-intro-seen";
...
export default function HomePage() {
  ...
  return (
    <div className={styles.page}>
      {introActive && (
        <section className={styles.introVideoStage} aria-label="TyreBrain AI intro animation">
          <video
            ref={introVideoRef}
            ...
            onError={finishIntro}
          />
          <div className={styles.introVideoShade} aria-hidden="true" />
          <button
            type="button"
        ...
        <div className={styles.heroContent}>
          <div className={styles.heroText}>
            ...
            <p className={styles.heroSub}>
              Self-adaptive, multi-layered tyre compounds that dynamically
              optimise <strong>grip, stiffness, and contact behaviour</strong>{" "}
              across all driving conditions — without sensors or electronics.
            </p>
      ...
      <section
        ...
        id="problem"
        aria-label="Industry Problem"
      >
        <div className="container">
          <div className={`text-center reveal ${styles.statsSectionTop}`}>
            <div className="section-label">The Problem</div>
            <h2 className="text-display-lg">
              The Problem with Traditional Tyre R&D
            </h2>
            <p className={styles.sectionDesc}>
              Traditional tyre development is slow, expensive, and constrained
              by static material systems. The industry hasn&apos;t changed —
              until now.
            </p>
          </div>
          ...
          <div className={styles.statsGrid}>
            {STATS.map((s, i) => (
              <div
                key={i}
                className={`card reveal stagger-${i + 1} ${styles.statCard}`}
              >
          ...
          <div className={`reveal stagger-4 ${styles.problemText}`}>
            <p>
              Static compounds cannot adapt to the dynamic demands of modern
              mobility: EVs, autonomous systems, and commercial fleets. R&D
              cycles lasting <strong>12–18 months</strong> with high prototyping
              costs make innovation slow and risky. TyreBrain AI changes the
              equation entirely.
            </p>
          </div>
        </div>
      ...
      <section
        ...
        id="solution"
        aria-label="TyreBrain Solution"
      >
        <div className={styles.solutionGlow} aria-hidden="true" />
        <div className="container">
          <div className={styles.solutionGrid}>
            <div
              className={`reveal-left ${styles.solutionVisual}`}
              aria-hidden="true"
            >
            ...
            <div className={`reveal-right ${styles.solutionText}`}>
              ...
              <h2 className="text-display-lg">
                A New Intelligence for Tyre Design
              </h2>
              <div className="divider" />
              <p>
                TyreBrain AI transforms tyre design into a fully autonomous
                computational process — combining generative AI,
                quantum-inspired optimisation, and digital twin simulation into
                a single, unified SaaS platform.
              </p>
      ...
      >
        <div className="container">
          <div className="text-center reveal">
            ...
            <p className={styles.sectionDesc}>
              Every TyreBrain AI compound is engineered through a four-layer
              computational stack.
            </p>
          </div>
          ...
          <div className={styles.pillarsGrid}>
            {PILLARS.map((p, i) => (
              ...
              >
                <div
                  className={`${styles.pillarIcon} ${p.color === "amber" ? styles.pillarIconAmber : ""}`}
                >
                  {p.icon}
                </div>
      ...
      {/* ━━━━━━━━━━━━━━━━━━━━ TRUST BAR ━━━━━━━━━━━━━━━━━━━━ */}
      <section className={styles.trustSection} id="trust-bar" aria-label="Trust Indicators">
        <div className="container">
          <p className={styles.trustTagline}>
            &ldquo;Built by an industry insider. Powered by{" "}
            <a
              href="https://levelweb.co.uk/"
              target="_blank"
        ...
        <div className="container">
          <div className={`text-center reveal ${styles.ctaContent}`}>
            ...
            <p className={styles.ctaDesc}>
              Join the frontier of tyre engineering. Book a private platform
              demonstration today.
            </p>
            ...
            <p className={styles.ctaNote}>
              No commitment required · United Kingdom based
            </p>
          </div>
        </div>
      </section>
